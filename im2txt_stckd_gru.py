...
model = builder.build_encoder_decoder_model(latent_dim,words_to_idx, word_embedding_size, num_decoder_tokens, num_of_stacked_rnn, (None, 4096), (22,), cell_type=GRU, masking=True)
